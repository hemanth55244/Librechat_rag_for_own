...
POSTGRES_DB = get_env_variable("POSTGRES_DB", "hemanth_rag")
POSTGRES_USER = get_env_variable("POSTGRES_USER", "hemanth_rag_user")
POSTGRES_PASSWORD = get_env_variable("POSTGRES_PASSWORD", "change_me_in_env")
